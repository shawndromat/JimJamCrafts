...
ActiveRecord::Schema.define(version: 20150103204704) do
  ...
  add_index "download_codes", ["order_number"], name: "index_download_codes_on_order_number", unique: true, using: :btree
